...
public class ReadyPacksContentCreator : MonoBehaviour {
    ...
    void Start()
    {
        headerFiles = Directory.GetFiles(@"C:\Skitto\Weekly Header\");
        itemContentFiles = Directory.GetFiles(@"C:\Skitto\Weekly Content\");
